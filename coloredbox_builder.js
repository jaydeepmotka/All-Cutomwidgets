(function () {
    let template = document.createElement("template");   // Layout structure
    template.innerHTML = `
  <form id="form">
  <fieldset>
  ...
  <tr>
  <td>Colour</td>
  <td><input id="builder_Colour" type="text" size="10" maxlength="10"></td>
  </tr>
  </table>
  <input type="submit" >
  </fieldset>
  ...
  `;
    class ColoredBoxBuilderPanel extends HTMLElement {
      ...
      set color(newColor) {
        this._shadowRoot.getElementById("builder_Colour").value = newColor;
      }
      get color() {
        return this._shadowRoot.getElementById("builder_Colour").value;
      }
    }
    customElements.define(
      "com-sap-sample-coloredbox-builder-mj",
